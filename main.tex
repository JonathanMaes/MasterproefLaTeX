...
% The symbol $E_{\alpha,i}$ represents the energy of the magnetization configuration with the $i$-th lowest energy out of all the relaxed configurations for which the input island has a magnetization angle near $\alpha$. 
...
\begin{figure}[b!]
    \centering
    \includegraphics[width=0.5\textwidth]{Figures/half_adder/regions000014.png} % TODO: larger or not? depends on if it fits on previous page
...
\end{figure} % Also maybe put the orther balancedness here as well to make two subfigures
