...
In conclusion, the standard reasoning behind this type of geometry, as explained some paragraphs ago, clearly does not work. The question is now, whether there exists a combination of $s$ and $d$ for which $B_1$ is positive. For this, radically different $s$ and $d$ were examined, which place the fixed island near the common axis of the free islands. This is the subject of the next section.
...
It does not seem to be good for the second balancedness metric, but inside the region there seems to be little variation of this metric except for a bit at the lower $d$ edge.
