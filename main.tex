...
Figure~\ref{fig:two-islands_interaction_(0.66,100)_a0,0} shows the total energy of two interacting islands, with nonzero shape anisotropy. To make the contribution of the shape anisotropy to the energy landscape as clear as possible, a geometry with high barrier ($\rho=0.66$) and a small grid (\SI{1}{\nano\metre}) were chosen.
