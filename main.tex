...
% TODO: Add formula for $\lambda$, perhaps not here but in the next section for the exchange energy
...
The following table is for $\alpha=0.01$:
...
% \begin{table}[b!]
    ...
    \begin{tabular}{c|c|c|c|c|c|c|c|c|c|c}
        ...
        \hline
        49x100 & 24.7 & 2 & 300 & 100 & 57 & 37 & 6 & \SI{2.06e9}{} & \SI{1.33e9}{} & \SI{2.16e8}{} \\
        \hline
...
\code{f0 = lambda N, dt, barrier, T: N*math.log(4)/dt*math.exp(barrier/1380649*16021766340/T)}
